# CopilotにGPT-5.5の登場でプロンプトの書き方は大きく変わります。

社内でAIを使うなら、正規の入口はMicrosoft Copilotです。

そこに最新モデルであるGPT-5.5が入ったことで、Copilotは「質問に答えるツール」から「仕事を任せる相手」に近づいています。

大きく変わるのは、プロンプトの書き方です。
